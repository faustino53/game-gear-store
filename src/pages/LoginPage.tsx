    ...
    <div className="max-w-md mx-auto">
      ...
      <Tabs defaultValue={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid grid-cols-3 mb-8">
          ...
          <TabsTrigger value="otp" className="data-[state=active]:bg-gaming-blue data-[state=active]:text-white">
            OTP Login
          </TabsTrigger>
        </TabsList>
          ...
          <div className="bg-gaming-gray rounded-lg p-6">
            {otpRequested ? (
              ...
              <form onSubmit={handleRequestOtp}>
                <div className="mb-6">
                  <Label htmlFor="otp-email" className="text-gaming-light">Email</Label>
                  <p className="text-sm text-gaming-light mb-4">
